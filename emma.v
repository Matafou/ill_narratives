...
Proof.
  intros p;one_step p;auto with proof.
(*
{E ⊸ A, (V ⊸ A) & 1, V} ⊢A ⊕ M
*)
Qed.
...
Proof.
  intros p;one_step p; eauto 3 with proof; eauto with proof.
(*
...
Proof.
  intros p;one_step p;auto with proof;eauto 3 with proof;eauto with proof.
(*
