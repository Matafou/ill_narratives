...
# coq_makefile basic.v emma.v formulas_spec.v formulas.v ILL_equiv.v ILL_paper_proofs.v ILL_spec.v ILL.v ILLVarInt.v multiset_spec.v multiset.v restrict2.v restrict.v vars.v 
#
